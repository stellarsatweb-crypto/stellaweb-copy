...
CREATE TABLE network_devices_staging (
    device_name   TEXT,
    site_name     TEXT,
    serial_number TEXT,
    mac_address   TEXT,
...
COPY network_devices_staging (device_name, site_name, serial_number, mac_address, model, license_due)
FROM 'E:\files\NetworkDeviceList_Quezon.csv'
DELIMITER ',' CSV HEADER ENCODING 'UTF8';
...
-- Replace the existing CREATE VIEW network_devices_full in STEP 9/referenced to equipment specs
DROP VIEW IF EXISTS network_devices_full CASCADE;
